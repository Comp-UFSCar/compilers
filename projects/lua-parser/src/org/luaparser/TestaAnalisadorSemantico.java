...
public class TestaAnalisadorSemantico {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = min; i <= max; i++) {
            ...
            InputStream casoDeTesteEntrada = TestaAnalisadorSemantico.class.getResourceAsStream("tests/entrada/" + nomeArquivo);
            ...
            parser.programa();
            InputStream casoDeTesteSaida = TestaAnalisadorSemantico.class.getResourceAsStream("tests/saida/" + nomeArquivo);
